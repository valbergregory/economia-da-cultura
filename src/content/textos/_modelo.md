---
# Copie este arquivo como AAAA-MM-DD-slug.md (a data só ordena; a URL usa o slug).
...
draft: true # troque para false ao publicar
---

Escreva aqui em Markdown. Títulos internos com `##`, citações com `>`, listas com `-`.
